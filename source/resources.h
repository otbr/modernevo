...
#define CLIENT_VERSION_STRING "Welcome to ModernOts!"

#define STATUS_SERVER_NAME "ModernOts Engine Edytion"
#define STATUS_SERVER_VERSION "For 8.6"
#define STATUS_SERVER_CODENAME "ModernOts Engine Edytion"
